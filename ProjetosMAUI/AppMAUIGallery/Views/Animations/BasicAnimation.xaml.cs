...
public partial class BasicAnimation : ContentPage
{
    ...
    {
        Image.TranslateTo(0, 185, 2000, Easing.BounceOut);
    }
    ...
    private async void Sequencial(object sender, EventArgs e)
    {
        ...
        await Image.TranslateTo(0, 100, 250);
        await Image.TranslateTo(0, -100, 500);
        await Image.TranslateTo(0, 0, 250);
    }
    ...
    private void Custom(object sender, EventArgs e)
    {
        ...
        principal.Commit(this, "AnimacaoPersonalizada", 16, 5000);
    }

    private void Cor(object sender, EventArgs e)
    {
        Image.ColorTo(Colors.Black, Colors.Violet, v => Image.Background = v, 2000);
    }
}